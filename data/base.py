...
class BaseDataset(paddle.io.Dataset):
    def __init__(self, root, split, mode=None, transform=None, 
                 target_transform=None, base_size=520, crop_size=480,num_class=19):
        self.root = root
    ...
    def _mask_transform(self, mask):
        return paddle.to_tensor(np.array(mask)).astype('int64')


# def test_batchify_fn(data):
#     error_msg = "batch must contain tensors, tuples or lists; found {}"
#     if isinstance(data[0], (str, paddle.Tensor)):
#         return list(data)
