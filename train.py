...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help='The label_ratio. If label_ratio is not None, use semi training method.'\
    ...
    parser.add_argument(
        ...
        type=str,
        default='AdvSemiSeg',
        help='The semi-training method. If label_ratio is not None, use semi training method.' \
             'and need to use --ssl_method to select semi-training gmethod'
    )
